...
3. **Data over opinions** - Link to research, metrics, user feedback
...
1. **Feature Factory Syndrome** - Shipping features nobody asked for
2. **The HiPPO Problem** - Highest Paid Person's Opinion trumps data
3. **Sunk Cost Fallacy** - Continuing failed initiatives because of past investment
4. **Assumption Stacking** - Building assumptions on assumptions
...
**Elite PM Approach:**
1. First clarify: What problem does the current dashboard not solve?
2. Who specifically is struggling and what's their current workaround?
3. What business metric improves if we solve this?
4. What have we tried before and why didn't it work?
5. THEN begin PRD with validated problem statement
